  ...
  content: [
    {
      block: 'warning',
      elem: 'content',
      mix: [{ block: 'informer', elem: 'content', mods: { distribute: 'center', 'space-a': 'xxl' } }],
      content: [
      {
      block: 'list',
      elem: 'item',
      ...
      content: [{
        ...
        {
          block: 'placeholder',
          mix: [{ block: 'placeholder', mods: { view: 'primary', size: 'm' } }],
        ...
        },
        {
          block: 'list',
          elem: 'item',
          mods: {'vertical-align': 'center', 'space-a': 'l', 'indent-b': 'm' },
          mix: [{block: 'card', elem: 'content', mods:{'vertical-align': 'center'}}],
          content: [
          {
          block: 'list',
          elem: 'item',
          mix: [{ block: 'theme', mods: {color: 'project-warning-accent'}}],
          content: [
        {
          block: 'text',
        ...
        block: 'list',
          ...
          block: 'warning',
          elem: 'button-wrapper',
          mix: [{ block: 'informer', elem: 'action', mods: { distribute: 'center', 'space-a': 'xxl' } }],
          content: [{
          block: 'button',
          mods: { size: 'l' },
          mix: [{ block: 'theme', mods: { 'color': 'project-warning-accent' } }],
