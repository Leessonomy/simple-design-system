const collectBlock = {
  ...
  mix: [
    { block: "collect", elem: "wrapper", mods: { position: "default" } },
      ...
      content: [
        {
          ...
          mix: [
            ...
            { block: "section", mods: { "space-v": "xxl" } },
            { block: "card", mods: { border: "all_brand" } }
          ],
          content: [
            {
              block: "collect",
              ...
              content: [
                {
                  ...
                  mix: [
                    {
                      block: "theme",
                      mods: { color: "project-default-default" }
                    }
                  ],
                  content: [
                    {
              ...
              content: [
                {
                  ...
                  mix: [
                    { block: "form", elem: "item", mods: { "space-v": "xxl" } }
                  ],
                  content: [
                    {
                      block: "text",
